...
/**
 * The interactive cutoff explorer. `initialMeta` is server-fetched by the
 * /cutoffs page so filters are populated in the initial HTML; the client
 * fetch only runs as a fallback when the server couldn't reach the backend.
 */
export default function CutoffsExplorer({ initialMeta }: { initialMeta?: CutoffMeta | null }) {
