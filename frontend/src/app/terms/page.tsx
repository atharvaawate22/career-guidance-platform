    ...
    <main style={{ minHeight: "100vh", background: "var(--ice)" }}>
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
        ...
        <div className="card p-6 sm:p-8 space-y-7 text-sm leading-7" style={{ color: "var(--ink-mid)" }}>
          <section>
            <h2 className="text-xl font-bold mb-2" style={{ color: "var(--ink)" }}>Informational platform</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-2" style={{ color: "var(--ink)" }}>Predictions are not guarantees</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-2" style={{ color: "var(--ink)" }}>Consultation bookings</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-2" style={{ color: "var(--ink)" }}>Limitation of liability</h2>
          ...
          <p><Link href="/privacy" style={{ color: "var(--gold)" }}>Read Privacy Policy</Link></p>
        </div>
      </section>
    </main>
  );
