...
export default function PrivacyPolicyPage() {
  return (
    <main style={{ minHeight: "100vh", background: "var(--ice)" }}>
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
        <p className="section-label mb-3">Legal</p>
        <h1 className="text-4xl font-bold mb-3" style={{ color: "var(--ink)", fontFamily: "var(--font-playfair)" }}>
          Privacy Policy
        </h1>
        <p className="text-sm mb-8" style={{ color: "var(--slate)" }}>
          Last updated: 20 May 2026
        </p>
        <div className="card p-6 sm:p-8 space-y-7 text-sm leading-7" style={{ color: "var(--ink-mid)" }}>
          <section>
            <h2 className="text-xl font-bold mb-2" style={{ color: "var(--ink)" }}>Data we collect</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-2" style={{ color: "var(--ink)" }}>Why we collect it</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-2" style={{ color: "var(--ink)" }}>Retention</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-2" style={{ color: "var(--ink)" }}>Sharing and storage</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-2" style={{ color: "var(--ink)" }}>Your rights</h2>
            <p>You can request deletion of your personal data by emailing <a href={`mailto:${contactEmail}`} style={{ color: "var(--gold)" }}>{contactEmail}</a>.</p>
          </section>
          <section>
            <h2 className="text-xl font-bold mb-2" style={{ color: "var(--ink)" }}>Official affiliation</h2>
          ...
          <p><Link href="/terms" style={{ color: "var(--gold)" }}>Read Terms of Service</Link></p>
        </div>
      </section>
    </main>
  );
